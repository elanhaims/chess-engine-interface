...
"""
    ...
    for k in range(8):
        ...
        cv.imwrite(f"new_pieces/black_{pieces[k]}_{square[k%2]}.png", black)
        white = gray[736-92:736, k*92:k*92 + 92]
        cv.imwrite(f"new_pieces/white_{pieces[k]}_{square[(k+1)%2]}.png", white)

    black_king_dark = gray[0:92, 368:460]
    cv.imwrite("new_pieces/black_king_dark.png", black_king_dark)
    white_king_light = gray[644:736, 368:460]
    cv.imwrite("new_pieces/white_king_light.png", white_king_light)
    black_queen_light = gray[0:92, 276:368]
    cv.imwrite("new_pieces/black_queen_light.png", black_queen_light)
    white_queen_dark = gray[644:736, 276:368]
    cv.imwrite("new_pieces/white_queen_dark.png", white_queen_dark)
    black_pawn_dark = gray[92:184, 0:92]
    cv.imwrite("new_pieces/black_pawn_dark.png", black_pawn_dark)
    black_pawn_light = gray[92:184, 92:184]
    cv.imwrite("new_pieces/black_pawn_light.png", black_pawn_light)
    white_pawn_light = gray[552:644, 0:92]
    cv.imwrite("new_pieces/white_pawn_light.png", white_pawn_light)
    white_pawn_dark = gray[552:644, 92:184]
    cv.imwrite("new_pieces/white_pawn_dark.png", white_pawn_dark)
